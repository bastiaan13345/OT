  ...
  return (
    <>
      <aside className="fixed inset-y-0 left-0 z-40 hidden w-64 flex-col border-r border-line bg-soft/95 px-4 py-5 backdrop-blur-2xl md:flex">
        ...
        >
          <Image src="/Infini.svg" alt="" width={52} height={52} priority className="dark:invert" />
        </Link>
        <Link
          href="/browse"
          className="mb-4 flex items-center gap-3 rounded-xl border border-line bg-canvas px-3 py-2.5 text-sm text-muted transition hover:border-ink hover:bg-panel hover:text-ink focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ink focus-visible:ring-offset-2"
        >
          ...
          {session ? (
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                aria-label="Sign out"
                className="rounded-full p-2 text-faint transition hover:bg-canvas hover:text-ink focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ink"
              >
            ...
            <Link
              href="/admin/login"
              className="flex items-center gap-3 rounded-xl px-3 py-2 text-sm text-muted transition hover:bg-canvas hover:text-ink focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ink"
            >
      ...
      <header className="fixed inset-x-0 top-0 z-40 flex h-16 items-center justify-between border-b border-line bg-canvas/95 px-4 backdrop-blur-2xl md:hidden">
        <Link
          href="/"
          aria-label="Infini home"
          className="rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ink focus-visible:ring-offset-2"
        >
          <Image src="/Infini.svg" alt="" width={36} height={36} priority className="dark:invert" />
        </Link>
        <div className="flex items-center gap-1">
          <ThemeToggle className="h-10 w-10 border-0 bg-transparent" />
          ...
          <Link href="/" aria-label="Home" className="rounded-full bg-ink p-2.5 text-canvas transition hover:opacity-80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ink focus-visible:ring-offset-2">
